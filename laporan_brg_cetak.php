				...
				<tbody>
					<tr>
						<td class="text-left" width="20%">
							<img src="foto/logo.jpeg" alt="logo-dkm" width="70" />
						</td>
						<td class="text-center" width="60%">
						<b>PT. Mafaaza Ilayya Bersama</b> <br>
						Banjarmasin<br>
			...
			<table class="table table-striped table-bordered table-hover" id="tabel-data">
				<thead>
					<tr>
						...
						<th width="10%">Keterangan</th> <!-- Tambahkan kolom Keterangan -->
						<th width="5%">Jumlah</th>
						<th width="10%">Harga</th>
						<th width="10%">Total Harga</th> <!-- Tambahkan kolom Total Harga -->
					</tr>
				</thead>
				<tbody>
					<?php
						...
						while($data = mysqli_fetch_array($ress)) {
							...
							echo '<td class="text-center">'. format_rupiah($total_barang) .'</td>'; // Total harga per transaksi
							echo '</tr>';												
							$i++;
						}
					?>
