...
<head>
	...
	<link href="foto/logo2.jpeg" rel="icon" type="images/x-icon">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					<img src="foto/logo.jpeg" alt="brand" width="50" class="float-left image-brand">
					<div class="float-right">&nbsp;<strong>PT. Mafaaza Ilayya Bersama</strong></div>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
							<h4>PT. Mafaaza Ilayya Bersama</h4>
