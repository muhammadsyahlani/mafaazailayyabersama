                                ...
                                <?php
                                    ...
                                    while($data = mysqli_fetch_array($ress)) {
                                        ...
                                        echo '<td class="text-center">
                                              ...
                                              <a href="supplier_hapus.php?spl='. $data['id_spl'] .'" onclick="return confirm(\'Apakah anda yakin akan menghapus '. htmlspecialchars($data['nama_spl'], ENT_QUOTES, 'UTF-8') . '?\');" class="btn btn-danger btn-xs">Hapus</a>
                                              <a href="daftar_harga_barang.php?spl='. $data['id_spl'] .'" class="btn btn-info btn-xs">Daftar Harga Barang</a>
                                              </td>';
                                        echo '</tr>';                                                
                                        $i++;
                                    }
