							...
							<div class="panel-body">
								<table class="table table-striped table-bordered table-hover" id="tabel-data">
									...
									<tbody>
										<?php
											$i = 1;
											$sql = "SELECT trx.*, konsumen.*, karyawan.* FROM trx, konsumen, karyawan WHERE
													trx.id_kon=konsumen.id_kon AND trx.id_karyawan=karyawan.id_karyawan ORDER BY trx.id_trx DESC";
